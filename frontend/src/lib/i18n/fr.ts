export default {
	...
	storageManager: {
		...
		raidTypes: {
			...
			raid6Desc: 'Double parité. Survit à 2 pannes de disques simultanées.',
			...
			btrfsRaid0Desc: 'Btrfs striping. Capacité maximale, pas de redondance.',
			btrfsRaid1Desc: 'Miroir Btrfs. Survit à 1 panne de disque.',
			btrfsRaid5Desc: 'Btrfs RAID5 avec parité. Survit à 1 panne de disque.',
			btrfsRaid6Desc: 'Btrfs RAID6 double parité. Survit à 2 pannes de disques.',
			btrfsRaid10: 'Btrfs RAID10',
			btrfsRaid10Desc: 'Btrfs Striping + Miroir. Haute performance avec redondance.'
		},
		modals: {
			createPool: {
		...
		smartTests: {
			tabInfo: 'Infos',
			tabTests: 'Auto-tests',
			tabSchedules: 'Planification',
			runTest: 'Lancer un test',
			shortTest: 'Test court',
			longTest: 'Test long',
			history: 'Historique des tests',
			noHistory: 'Aucun historique de test disponible',
			testType: 'Type de test',
			lifetime: 'Heures',
			scheduleTitle: 'Tests planifiés',
		...
		power: {
			...
			spindown: 'Mise en veille',
			writeCache: 'Cache d\'écriture',
			writeCacheWarning: 'Désactiver le cache d\'écriture réduit les performances mais améliore la sécurité des données',
			notSupported: 'Gestion de l\'énergie non supportée pour ce type de périphérique'
		},
		snapshots: {
			title: 'Instantanés',
			...
			btrfsOnly: 'Les instantanés sont disponibles uniquement pour les volumes btrfs',
			namePlaceholder: 'Nom de l\'instantané',
			confirmDelete: 'Êtes-vous sûr de vouloir supprimer cet instantané ?',
			manual: 'Manuel',
			scheduled: 'Planifié'
		},
		grow: {
			addDisks: 'Ajouter des disques',
			currentDisks: 'disque(s)',
			selectNewDisks: 'Sélectionner les nouveaux disques',
			noCandidates: 'Aucun disque disponible',
			expanding: 'Extension en cours...',
			raidConstraint: 'Le RAID 10 nécessite un nombre pair de nouveaux disques',
			basicNoGrow: 'Impossible d\'ajouter des disques à un pool basique',
			wipeDevices: 'Effacer les nouveaux disques avant l\'ajout',
			startExpand: 'Démarrer l\'extension',
			warning: 'L\'extension d\'un pool ne peut pas être annulée.'
		},
		errors: {
